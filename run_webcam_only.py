...
def enlarge(image):
    image_enlarge = cv2.resize(image, (LARGE_SIZE, LARGE_SIZE))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--show', dest='display_landmark', type=int, default=2, choices=[0, 1, 2],
